...
public interface ObservadorEfectos {

    void actualizar(SorpresaFavorable sorpresaFavorable);
    void actualizar(SorpresaDesfavorable sorpresaDesfavorable);
    void actualizar(CambioDeVehiculo cambioDeVehiculo);
    void actualizar(SorpresaNull sorpresaNull);
