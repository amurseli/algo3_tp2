...
public class VehiculoView implements Observer {
    ...
    public VehiculoView(Vehiculo vehiculo, Group layout, Rectangle mapa){
        ...
        vehiculoView.setY(inicioY + vehiculo.obtenerPosicion().fila * MULTIPLICADOR - DESFASE);
    ...
    public void actualizarPosicion(){
        ...
        vehiculoView.setY(inicioY + vehiculo.obtenerPosicion().getFila() * MULTIPLICADOR -DESFASE);
