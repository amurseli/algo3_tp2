...
public class MovimientosTest {
    ...
    public void Test01MoverseIzquierda(){
        ...
        Assertions.assertEquals(juego.ciudad.p1.vehiculo.posicion, new Esquina(2,1));
    }
    @Test
    public void Test02MoverseDerecha(){
        ...
        juego.crearCiudad(10,10,new Esquina(10,10),new Auto(new Esquina(2,2)));
        juego.moverDerecha();
        Assertions.assertEquals(juego.ciudad.p1.vehiculo.posicion, new Esquina(2,3));
    }
    @Test
    public void Test03MoverseArriba(){
        ...
        juego.crearCiudad(10,10,new Esquina(10,10),new Auto(new Esquina(2,2)));
        juego.moverArriba();
        Assertions.assertEquals(juego.ciudad.p1.vehiculo.posicion, new Esquina(1,2));
    }
    @Test
    public void Test04MoverseAbajo(){
        ...
        juego.crearCiudad(10,10,new Esquina(10,10),new Auto(new Esquina(2,2)));
        juego.moverAbajo();
        Assertions.assertEquals(juego.ciudad.p1.vehiculo.posicion, new Esquina(3,2));
    }
    @Test
